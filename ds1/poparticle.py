...
sample_data['meta_description'].to_frame(),
sample_data['type'].to_frame()]
...
cur = conn.cursor() 
cur.copy_from(f, 'article', columns=('article_id', 'content', 'title', 'summary', 'meta_description', 'type_id'), sep=',')
conn.commit()
cur.close()
