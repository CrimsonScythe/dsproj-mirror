...
def process_dfs(readerObj, processor_function):
    firstFrame = processor_function(next(readerObj))
    i = 0
    done_looping = False
    ...
    while not done_looping:
        try:
            ...
            cleaned_df = processor_function(df)
            firstFrame = firstFrame.append(cleaned_df)
...
complete_df = process_dfs(reader, chunk_preprocessing)
