...
def chunk_preprocessing(sample_data):
    ...
    # WTF is the purpose of this line? I've commented it out now :D
...
for chunk in df_chunk:
    ...
    if first_time_processing:
        chunk_filter.to_csv('clean_article_dfs.csv', index=False)
        first_time_processing = False
    else:
        chunk_filter.to_csv('clean_article_dfs.csv', mode='a', index=False)
...
df = pd.read_csv('clean_article_dfs.csv')
